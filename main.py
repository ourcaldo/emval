...
def main():
    ...
    try:
        ...
        print(f"✓ Progress saved: {completed}/{len(emails)} emails processed")
        logger.info(f"Validation interrupted by user at {completed}/{len(emails)} emails")
        # Don't exit - let the summary print below with partial results
